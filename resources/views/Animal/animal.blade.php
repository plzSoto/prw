...
<div class="animal-card" style="border: 1px solid #ccc; padding: 10px; margin-bottom: 10px;">
    <h2>{{ $animal->NOMBRE }}</h2>
    ...
    <button onclick="window.location.href = '{{ route('Animal.editAnimal', ['id' => $animal->ID]) }}'">Editar</button>
