...
INSERT INTO `SOSANIMALES`.`T_COLOR` (`COLOR`) VALUES ('BLANCO'), ('NEGRO'), ('GRIS'), ('MARRON');

INSERT INTO `SOSANIMALES`.`T_TAMAÑO` (`TAMAÑO`) VALUES ('PEQUEÑO'), ('MEDIANO'), ('GRANDE');

INSERT INTO `SOSANIMALES`.`T_ESPECIE` (`ESPECIE`) VALUES ('PERRO'), ('GATO');

INSERT INTO `SOSANIMALES`.`T_ESTADO` (`ESTADO`) VALUES ('PERDIDO'), ('ENCONTRADO'), ('DEVUELTO');
