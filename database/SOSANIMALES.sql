...
INSERT IGNORE INTO `SOSANIMALES`.`T_CONTACTOEXTRA` (`ID`, `NOMBRE`, `TELEFONO`, `EMAIL`) VALUES
('1', 'Alberto', '928123456', '9qVbS@example.com');

INSERT IGNORE INTO `SOSANIMALES`.`T_ANIMAL` (`ID`, `NOMBRE`, `DESCRIPCION`, `IMAGEN`,`COLOR_ID`, `ESPECIE_ID`, `TAMAÑO_ID`) VALUES
('1', 'Pollo', 'Pollo de 4 patas', 'pollo.jpg', '1', '1', '1');

INSERT IGNORE INTO `SOSANIMALES`.`T_AVISO` (`ID`, `FECHADESAPARECIDO`, `LUGARDESAPARECIDO`, `ANIMAL_ID`, `CONTACTOEXTRA_ID`, `ESTADO_ID`) VALUES
('1', '11/12/2000', 'El Tablero', '1', '1', '1');
